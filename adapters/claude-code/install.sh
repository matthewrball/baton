#!/usr/bin/env bash
# baton enhanced adapter installer — copies the portable skill and Claude hooks,
...
mkdir -p "$CLAUDE_DIR/skills/baton" "$CLAUDE_DIR/hooks" "$CLAUDE_DIR/baton"
cp -R "$REPO_DIR/skills/baton/." "$CLAUDE_DIR/skills/baton/"
cp "$ADAPTER_DIR/hooks/"baton-*.mjs "$CLAUDE_DIR/hooks/"
...
echo "──────────────────────────────────────────────────────────────────────"
cat "$ADAPTER_DIR/settings.snippet.json"
echo "──────────────────────────────────────────────────────────────────────"
echo
echo "Optional: enable Linear sync by copying $ADAPTER_DIR/config.example.json → $CLAUDE_DIR/baton/config.json"
echo
